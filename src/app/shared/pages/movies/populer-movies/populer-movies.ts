...
@Component({
  ...
  templateUrl: './populer-movies.html',
  styleUrl: './populer-movies.css',
})
export class PopulerMovies implements OnInit {
  mediaItems: IMovie[] = [];
  ...
  loadMovies(page: number) {
    this.movieServices.getPopularMovies(page).subscribe({
