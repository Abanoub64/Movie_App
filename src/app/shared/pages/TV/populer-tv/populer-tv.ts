...
@Component({
  selector: 'app-populer-tv',
  imports: [ListDialog, ZardPaginationComponent, MovieCard],
  templateUrl: './populer-tv.html',
  styleUrl: './populer-tv.css',
})
export class PopulerTV implements OnInit {
  mediaItems: IMovie[] = [];
  ...
  loadMovies(page: number) {
    this.tvservices.getTVpopular(page).subscribe({
